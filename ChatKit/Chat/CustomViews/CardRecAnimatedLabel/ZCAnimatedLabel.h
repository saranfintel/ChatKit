...
@optional
    - (void)didFinishLoadingLabel:(UIView *)label;
@end

@interface ZCAnimatedLabel : UIView<AnimationDelegate>

@property (nonatomic, weak) id <AnimationDelegate> animationdelegate;
