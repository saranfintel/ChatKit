...
SWIFT_CLASS("_TtC10MessageKit16AudioMessageCell")
@interface AudioMessageCell : MessageContentCell
- (void)prepareForReuse;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
/// A <code>UIView</code> subclass that maintains a mask to keep it fully circular
SWIFT_CLASS("_TtC10MessageKit12BubbleCircle")
@interface BubbleCircle : UIView
...
SWIFT_CLASS("_TtC10MessageKit18ContactMessageCell")
@interface ContactMessageCell : MessageContentCell
- (void)applyLayoutAttributes:(UICollectionViewLayoutAttributes * _Nonnull)layoutAttributes;
- (void)prepareForReuse;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
///     reserved for it with <code>isSectionReservedForTypingIndicator</code> defined in
///     <code>MessagesCollectionViewFlowLayout</code>
///   </li>
/// </ul>
...
/// A subclass of <code>UIView</code> that mimics the iMessage typing bubble
SWIFT_CLASS("_TtC10MessageKit12TypingBubble")
@interface TypingBubble : UIView
...
/// A <code>UIView</code> subclass that holds 3 dots which can be animated
SWIFT_CLASS("_TtC10MessageKit15TypingIndicator")
...
/// A subclass of <code>MessageCollectionViewCell</code> used to display the typing indicator.
SWIFT_CLASS("_TtC10MessageKit19TypingIndicatorCell")
@interface TypingIndicatorCell : MessageCollectionViewCell
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)prepareForReuse;
- (void)layoutSubviews;
